...
public interface RmiUserManagementService extends Remote {
   ...
   *                 minimum two visible characters.
   ...
   * @throws InvalidTokenException        if the token is no valid token from this user management
   *                                      service
   * @throws ServiceNotAvailableException if the service cannot be provided
   */
  ...
  void changeName(Token userToken, String newName) throws IllegalParameterException,
      InvalidTokenException, UserNameAlreadyAssignedException, ServiceNotAvailableException, RemoteException;
}
