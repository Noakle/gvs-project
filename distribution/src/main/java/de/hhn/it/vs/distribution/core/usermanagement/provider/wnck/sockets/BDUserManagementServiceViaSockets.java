...
public class BDUserManagementServiceViaSockets implements BDUserManagementService {
    ...
    public BDUserManagementServiceViaSockets(final String hostname, final int portNumber) {
