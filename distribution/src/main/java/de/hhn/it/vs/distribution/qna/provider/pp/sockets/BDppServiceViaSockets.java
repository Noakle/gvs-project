...
import static de.hhn.it.vs.distribution.fdkh.provider.socket.fdkhServiceServeOneClient.CREATE_QUESTION;
import static de.hhn.it.vs.distribution.fdkh.provider.socket.fdkhServiceServeOneClient.GET_ANSWER;
import static de.hhn.it.vs.distribution.fdkh.provider.socket.fdkhServiceServeOneClient.GET_ANSWER_IDS;
import static de.hhn.it.vs.distribution.fdkh.provider.socket.fdkhServiceServeOneClient.GET_AREA;
import static de.hhn.it.vs.distribution.fdkh.provider.socket.fdkhServiceServeOneClient.GET_AREA_IDS;
import static de.hhn.it.vs.distribution.fdkh.provider.socket.fdkhServiceServeOneClient.GET_QUESTION;
import static de.hhn.it.vs.distribution.fdkh.provider.socket.fdkhServiceServeOneClient.GET_QUESTION_IDS;
import static de.hhn.it.vs.distribution.fdkh.provider.socket.fdkhServiceServeOneClient.PARAM_ANSWERE;
import static de.hhn.it.vs.distribution.fdkh.provider.socket.fdkhServiceServeOneClient.PARAM_ANSWERE_ID;
import static de.hhn.it.vs.distribution.fdkh.provider.socket.fdkhServiceServeOneClient.PARAM_AREA;
import static de.hhn.it.vs.distribution.fdkh.provider.socket.fdkhServiceServeOneClient.PARAM_AREA_ID;
import static de.hhn.it.vs.distribution.fdkh.provider.socket.fdkhServiceServeOneClient.PARAM_QUESTION;
import static de.hhn.it.vs.distribution.fdkh.provider.socket.fdkhServiceServeOneClient.PARAM_QUESTION_ID;
import static de.hhn.it.vs.distribution.fdkh.provider.socket.fdkhServiceServeOneClient.PARAM_USER_TOKEN;
import static de.hhn.it.vs.distribution.fdkh.provider.socket.fdkhServiceServeOneClient.UPDATE_ANSWERE;
import static de.hhn.it.vs.distribution.fdkh.provider.socket.fdkhServiceServeOneClient.UPDATE_AREA;
import static de.hhn.it.vs.distribution.fdkh.provider.socket.fdkhServiceServeOneClient.UPDATE_QUESTION;
...
public class BDppServiceViaSockets implements BDQnAService {
    private static final org.slf4j.Logger logger =
            org.slf4j.LoggerFactory.getLogger(BDppServiceViaSockets.class);
    ...
    public BDppServiceViaSockets(final String hostname, final int portNumber) {
    ...
    public long createAnswer(Token userToken, long areaId, long questionId, Answer answer) throws ServiceNotAvailableException, IllegalParameterException, InvalidTokenException {
        Request request = new Request(CREATE_ANSWERE)
                ...
                .addParameter(PARAM_ANSWERE, answer);
        Response response = sendAndGetResponse(request);
        if (response.isException()) {
            rethrowStandardExceptions(response);
        }
    ...
    public Answer getAnswer(Token userToken, long areaId, long questionId, long answerId) throws ServiceNotAvailableException, IllegalParameterException, InvalidTokenException {
        Request request = new Request(GET_ANSWER)
                ...
                .addParameter(PARAM_AREA_ID, areaId)
                .addParameter(PARAM_QUESTION_ID, questionId)
                .addParameter(PARAM_ANSWERE_ID, answerId);
        Response response = sendAndGetResponse(request);
        if (response.isException()) {
            rethrowStandardExceptions(response);
        }
    ...
    public void updateAnswer(Token userToken, long areaId, long questionId, Answer answer) throws ServiceNotAvailableException, IllegalParameterException, InvalidTokenException {
        Request request = new Request(UPDATE_ANSWERE)
                .addParameter(PARAM_USER_TOKEN, userToken)
                .addParameter(PARAM_AREA_ID, areaId)
                .addParameter(PARAM_QUESTION_ID, questionId)
                .addParameter(PARAM_ANSWERE, answer);
