...
public class rbawServiceServeOneClient extends AbstractServeOneClient {
    private static final org.slf4j.Logger logger =
            org.slf4j.LoggerFactory.getLogger(rbawServiceServeOneClient.class);
    ...
    public rbawServiceServeOneClient(final Socket socket, final Object service) throws IOException, IllegalParameterException {
            ...
            switch (methodToCall) {
                ...
                default:
                    ...
                    ServiceNotAvailableException noMethodException = new ServiceNotAvailableException
                            ("Method with name unknown. " + methodToCall);
