package de.hhn.it.vs.distribution.qna.provider.raat.testclient.testclient;
...
public class RaatQnADemoClient {
    private static final org.slf4j.Logger logger =
            org.slf4j.LoggerFactory.getLogger(RaatQnADemoClient.class);
    ...
    public static void main(String[] args) throws Exception {
        RaatQnADemoClient client = new RaatQnADemoClient(TestMode.SOCKET);
        client.runDemo();
    }
